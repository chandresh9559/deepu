                    ...
                    <td>
                      ...
                      <td class="align-middle">
                        ...
                        if($project->status == 2){
                          ...
                          echo $this->Html->link(__(''), ['controller' => 'Projetcs','prefix'=>'Admin','action' => 'projectDeleteRecover', $project->id], ['class'=>'fa-sharp fa-solid fa-trash','id'=>'delete'],['confirm'=>'Are you sure you want to delete']);
                        }
                        ?>
                        </td>
                    </tr>
